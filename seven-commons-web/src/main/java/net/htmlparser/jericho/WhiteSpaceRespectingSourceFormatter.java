 ...
 */
public final class WhiteSpaceRespectingSourceFormatter implements CharStreamSource {
	 ...
	 */
	public WhiteSpaceRespectingSourceFormatter(final Segment segment) {
	 ...
	 * @see #getIndentString()
	 */
	public WhiteSpaceRespectingSourceFormatter setIndentString(final String indentString) {
	 ...
	 * @see #getTidyTags()
	 */
	public WhiteSpaceRespectingSourceFormatter setTidyTags(final boolean tidyTags) {
	 ...
	 */
	public WhiteSpaceRespectingSourceFormatter setCollapseWhiteSpace(final boolean collapseWhiteSpace) {
	 ...
	 */
	WhiteSpaceRespectingSourceFormatter setRemoveLineBreaks(final boolean removeLineBreaks) {
	 ...
	 */
	public WhiteSpaceRespectingSourceFormatter setIndentAllElements(final boolean indentAllElements) {
	 ...
	 * @see #getNewLine()
	 */
	public WhiteSpaceRespectingSourceFormatter setNewLine(final String newLine) {
	...
	private static final class Processor {
		...
		private boolean inlinable(final Element element) {
			...
			//if(! element.isEmpty() && !element.isEmptyElementTag() && !element.isWhiteSpace()) {
			if(startTagType==StartTagType.NORMAL) {
				final Segment segment = element.getContent();
				final CharSequence begin = segment.getSource().subSequence(segment.getBegin(), segment.getBegin() + 1);
				if(! Character.isWhitespace(begin.charAt(0))) {
					return true;
				}
			}
